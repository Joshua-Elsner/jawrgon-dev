...
BEGIN
    ...
    -- 3. Identify the new award winners using window functions [cite: 208]
    ...
    -- ==========================================
    -- 6. NEW: THE ALL-TIME STATS VAULT BACKUP
    -- ==========================================
    INSERT INTO player_stats_snapshots (
        player_id, snapshot_date, all_time_time_as_shark, fish_eaten, sharks_evaded,
        yoinks, all_time_guesses, all_time_puzzles_played, shark_of_the_week_wins,
        silver_medals, bronze_medals, jawbreaker_awards, robster_awards,
        apex_predator_awards, efishent_awards
    )
    SELECT 
        id, CURRENT_DATE, all_time_time_as_shark, fish_eaten, sharks_evaded,
        yoinks, all_time_guesses, all_time_puzzles_played, shark_of_the_week_wins,
        silver_medals, bronze_medals, jawbreaker_awards, robster_awards,
        apex_predator_awards, efishent_awards
    FROM players
    ...
    -- 7. RESET ALL WEEKLY STATS TO 0 (Leave All-Time stats untouched) 
    UPDATE players
    ...
    -- 8. Reset active game state 
    UPDATE game_state
    SET current_shark_id = NULL, secret_word = 'SHARK', shark_start_time = NOW()
    WHERE id = 1; 

    -- 9. ARCHIVE AND WIPE THE USED WORDS DICTIONARY 
